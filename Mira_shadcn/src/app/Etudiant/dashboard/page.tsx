...
import { isLoggedIn, loggedasadministratif, loggedasetudiant } from '@/lib/utils/auth'; // Fonctions pour vérifier si l'utilisateur est authentifié et s'il est administratif

import PageTitle from '@/components/dashboard/PageTitle';
import AdministratifLayout from '../EtudiantLayout';
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!isLoggedIn() || !loggedasetudiant()) {
