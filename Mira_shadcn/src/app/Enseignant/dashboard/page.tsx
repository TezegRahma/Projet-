...
import { isLoggedIn, loggedasadministratif, loggedasenseignant } from '@/lib/utils/auth'; // Fonctions pour vérifier si l'utilisateur est authentifié et s'il est administratif

import PageTitle from '@/components/dashboard/PageTitle';
import AdministratifLayout from '../EnseignantLayout';
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!isLoggedIn() || !loggedasenseignant()) {
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        <section className="grid grid-cols-1 gap-4 transition-all lg:grid-cols-2">
          ...
          <CardContent className="flex justify-between gap-4">
            <section>
              <p>Tableau de board Enseignant </p>
