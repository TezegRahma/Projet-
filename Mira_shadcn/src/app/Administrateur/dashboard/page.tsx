...
import { isLoggedIn, loggedasadministrateur, loggedasadministratif } from '@/lib/utils/auth'; // Fonctions pour vérifier si l'utilisateur est authentifié et s'il est administratif
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!isLoggedIn() || !loggedasadministrateur()) {
    ...
    <AdminLayout>
      <div className="flex flex-col gap-5 w-full">
        ...
        <section className="grid grid-cols-1 gap-4 transition-all lg:grid-cols-2">
          <CardContent>
          <CardTitle>Tableau de board Administrateur</CardTitle>
          </CardContent>
