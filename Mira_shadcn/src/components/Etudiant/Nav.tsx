  ...
  return (
    <div className="navbar bg-base-100 fixed top-0 left-0 w-full z-10">
      ...
      <ul className="menu menu-horizontal px-1">
          <li><a href="/Etudiant/reglementinterne"> Reglement Interieur </a></li>
          <li><a href="/Etudiant/reglementExamens">Reglements des examens</a></li>
          <li><a href="/Etudiant/reglementloi">Loi et circulation</a></li>
